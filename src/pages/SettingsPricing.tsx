      ...
      <div className="px-4 py-4 pb-32 space-y-6">
        ...
        <div className="flex items-center justify-center gap-2 p-1 bg-secondary rounded-xl">
          <button
            ...
            className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors ${billingCycle === 'monthly'
          ...
          <button
            ...
            className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 ${billingCycle === 'yearly'
              ? 'bg-primary text-primary-foreground'
              : 'text-muted-foreground hover:text-foreground'
              }`}
          >
